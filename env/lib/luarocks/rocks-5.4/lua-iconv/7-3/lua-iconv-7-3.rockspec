...
external_dependencies = {
   ...
   platforms = {
      ...
      windows = iconv_library_dependency_override,
      win32 = iconv_library_dependency_override,
   }
}
...
build = {
   ...
   platforms = {
      ...
      windows = iconv_library_module_override,
      win32 = iconv_library_module_override,
   }
}
